...
[[nodiscard]]
inline constexpr uint8_t getHighByte(uint16_t twoBytes) noexcept {
...
[[nodiscard]]
inline constexpr uint8_t getLowByte(uint16_t twoBytes) noexcept {
...
[[nodiscard]]
inline constexpr uint16_t bindTwoBytes(uint8_t highByte, uint8_t lowByte) noexcept {
